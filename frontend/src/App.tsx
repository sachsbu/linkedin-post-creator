...
import { Story, PostResponse, ToneOption, ProviderOption, PlatformOption, InstagramPostResponse } from './types';
import { fetchTrendingStories, generatePost, fetchPostHistory, generateInstagramPost } from './api/client';
...
export const App: React.FC = () => {
  ...
  // Instagram State
  const [instagramPost, setInstagramPost] = useState<InstagramPostResponse | null>(null);
  ...
  const handleGenerateLinkedIn = async (targetStory?: Story) => {
  ...
  const handleGenerateInstagram = async (
    ...
    try {
      ...
      setInstagramPost(result);
    } catch (err: any) {
      setInstagramError(err?.response?.data?.detail || 'Failed to generate Instagram post.');
    } finally {
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {selectedPlatform === 'linkedin' ? (
          ...
          /* Instagram Workflow */
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            {/* Left Column: Instagram Input Form (5 Cols) */}
            <div className="lg:col-span-5 flex flex-col space-y-6">
              <InstagramForm
                onGenerate={handleGenerateInstagram}
            ...
            {/* Right Column: Instagram Preview (7 Cols) */}
            <div className="lg:col-span-7">
              <InstagramPreview
                post={instagramPost}
                isGenerating={isGeneratingInstagram}
